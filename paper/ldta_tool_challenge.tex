...
keywords={MODULE, END, PROCEDURE, VAR, TYPE, CONST, FOR, WHILE, CASE, IF, BEGIN, ELSIF, THEN, ARRAY, OF, RECORD},
sensitive=true
}
...
\bibliography{silver/silver,jastadd/jastadd,ocaml/ocaml,kiama/kiama,simpl/simpl}
