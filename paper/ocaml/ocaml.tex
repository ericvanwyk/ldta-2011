...
name appers in. For example, left side of assignment should designate variable or procedure argument,
all references in constant expressions should designate constants etc.
...
Each expression checking function is itself aquired by applying the generic transformer 
...
generic transformers with identity monad.
\end{itemize}
