...
initial AST does not have any type information (and even doest not have any ``placeholders'' 
...
transformations are performed using per-type generic transformers.
