...
Camlp4/Camlp5\footnote{http://pauillac.inria.fr/\textasciitilde ddr/camlp5/} --- which allows to
extend the host language with domain-specific constructs. We argue that in its present state OCaml 
is already rich enough to be directly used as an implementation formalism for all the task listed 
for the tool challenge. 
...
In our implementation of Oberon0 we used three monads --- a variant 
